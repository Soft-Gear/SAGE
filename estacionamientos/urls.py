...
urlpatterns = patterns('',
    ...
    url(r'^moverReservaHorario/moverReservaMoverRecargar$', views.estacionamiento_RecargarBilleteraMover, name = 'estacionamiento_RecargaBilleteraMover'),
    ...
    url(r'^billetera_electronica/cambiar_pin$', views.billetera_electronica_cambiar_pin, name = 'billetera_electronica_cambiar_pin'),
