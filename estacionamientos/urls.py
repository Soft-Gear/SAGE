...
urlpatterns = patterns('',
    ...
    url(r'^billetera_electronica_saldo$', views.billetera_electronica_saldo, name = 'billetera_electronica_saldo'),
    url(r'^billetera_electronica_recarga$', views.billetera_electronica_recarga, name = 'billetera_electronica_recarga'),
