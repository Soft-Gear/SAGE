...
class TarifaMinutoTestCase(TestCase):
    ...
    def test_tarifa_minuto_un_minuto(self): # Borde
        ...
        self.assertEqual(rate.calcularPrecio(initial_time,final_time,'Carro'),1)
    ...
    def test_tarifa_minuto_una_hora(self): # Borde
        ...
        rate = TarifaMinuto(tarifa_carros = 60)
        self.assertEqual(rate.calcularPrecio(initial_time,final_time,'Carro'),60)
    ...
    def test_tarifa_minuto_un_dia_menos_un_minuto(self): # Borde
        ...
        rate = TarifaMinuto(tarifa_carros = 60)
        self.assertEqual(rate.calcularPrecio(initial_time,final_time,'Carro'),1439)
    ...
    def test_tarifa_minuto_un_dia_mas_un_minuto(self): # TDD
        ...
        rate = TarifaMinuto(tarifa_carros = 60)
        self.assertEqual(rate.calcularPrecio(initial_time,final_time,'Carro'),1441)
