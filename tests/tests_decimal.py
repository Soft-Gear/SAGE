...
class DecimalTestCase(TestCase):
    ...
    def test_tarifa_hora_microbuses_decimal(self):
        rate=TarifaHora(tarifa_microbus=0.3)
        initial_time=datetime(2015,2,20,15,0)
        final_time=datetime(2015,2,20,18,0)
        vehiculo ='Microbus'
        value = rate.calcularPrecio(initial_time, final_time, vehiculo)
    ...
    def test_tarifa_hora_autobuses_decimal(self):
        rate=TarifaHora(tarifa_autobus=0.3)
        initial_time=datetime(2015,2,20,15,0)
        final_time=datetime(2015,2,20,18,0)
        vehiculo ='Autobus'
        value = rate.calcularPrecio(initial_time, final_time, vehiculo)
    ...
    def test_tarifa_minuto_microbuses_decimal(self):
        rate=TarifaMinuto(tarifa_microbus=0.3)
        initial_time=datetime(2015,2,20,15,0)
        final_time=datetime(2015,2,20,18,30)
        vehiculo = 'Microbus'
        value = rate.calcularPrecio(initial_time, final_time, vehiculo)
    ...
    def test_tarifa_minuto_autobuses_decimal(self):
        rate=TarifaMinuto(tarifa_autobus=0.3)
        initial_time=datetime(2015,2,20,15,0)
        final_time=datetime(2015,2,20,18,30)
        vehiculo = 'Autobus'
        value = rate.calcularPrecio(initial_time, final_time, vehiculo)
    ...
    def test_tarifa_hora_y_fraccion_Microbuses_decimal(self):
        rate=TarifaHorayFraccion(tarifa_microbus=0.3)
        initial_time=datetime(2015,2,20,15,0)
        final_time=datetime(2015,2,20,17,25)
        vehiculo = 'Microbus'
        value = rate.calcularPrecio(initial_time, final_time, vehiculo)
    ...
    def test_tarifa_hora_y_fraccion_Autobuses_decimal(self):
        rate=TarifaHorayFraccion(tarifa_autobus=0.3)
        initial_time=datetime(2015,2,20,15,0)
        final_time=datetime(2015,2,20,17,25)
        vehiculo = 'Autobus'
        value = rate.calcularPrecio(initial_time, final_time, vehiculo)
    ...
    def test_tarifa_pico_microbuses_decimal(self):
        inicio = time(6,0)
        fin = time(18,0)
        tarifa = TarifaHoraPico(tarifa_microbus=0.1,tarifa2_microbus=0.3,inicioEspecial=inicio,finEspecial=fin)
        inicioReserva = datetime(2015,1,1,15)
        finReserva = datetime(2015,1,1,20)
        vehiculo = 'Microbus'
        valor = tarifa.calcularPrecio(inicioReserva,finReserva,vehiculo)
    ...
    def test_tarifa_pico_autobuses_decimal(self):
        inicio = time(6,0)
        fin = time(18,0)
        tarifa = TarifaHoraPico(tarifa_autobus=0.1,tarifa2_autobus=0.3,inicioEspecial=inicio,finEspecial=fin)
        inicioReserva = datetime(2015,1,1,15)
        finReserva = datetime(2015,1,1,20)
        vehiculo = 'Autobus'
        valor = tarifa.calcularPrecio(inicioReserva,finReserva,vehiculo)
    ...
    def test_tarifa_fin_de_semana_microbus_decimal(self):
        tarifa = TarifaFinDeSemana(tarifa_microbus=0.1,tarifa2_microbus=0.3)
        inicioReserva = datetime(2015,3,6,22)
        finReserva = datetime(2015,3,7,3)
        vehiculo = 'Microbus'
        valor = tarifa.calcularPrecio(inicioReserva,finReserva,vehiculo)
    ...
    def test_tarifa_fin_de_semana_autobuses_decimal(self):
        tarifa = TarifaFinDeSemana(tarifa_autobus=0.1,tarifa2_autobus=0.3)
        inicioReserva = datetime(2015,3,6,22)
        finReserva = datetime(2015,3,7,3)
        vehiculo = 'Autobus'
        valor = tarifa.calcularPrecio(inicioReserva,finReserva,vehiculo)
