...
class HoraPicoTestCase(TestCase):
    ...
    def test_tarifa_hora_pico_valle_valle_por_media_hora(self): #Borde
        inicio = time(6,0)
        fin = time(18,0)
        tarifa = TarifaHoraPico(tarifa_carros=60,tarifa2_carros=120,inicioEspecial=inicio,finEspecial=fin)
    ...
    def test_tarifa_hora_pico_valle_valle_por_cuarto_de_hora(self): #Borde
        inicio = time(6,0)
        fin = time(18,0)
        tarifa = TarifaHoraPico(tarifa_carros=60,tarifa2_carros=120,inicioEspecial=inicio,finEspecial=fin)
    ...
    def test_tarifa_hora_pico_valle_pico_por_una_hora(self): #Esquina
        inicio = time(6,0)
        fin = time(18,0)
        tarifa = TarifaHoraPico(tarifa_carros=60,tarifa2_carros=120,inicioEspecial=inicio,finEspecial=fin)
    ...
    def test_tarifa_hora_pico_valle_pico_por_media(self): #Esquina
        inicio = time(6,0)
        fin = time(18,0)
        tarifa = TarifaHoraPico(tarifa_carros=60,tarifa2_carros=100,inicioEspecial=inicio,finEspecial=fin)
        inicioReserva = datetime(2015,1,1,7,30)
        finReserva = datetime(2015,1,1,8)
        valor = tarifa.calcularPrecio(inicioReserva,finReserva,'Carro')
        self.assertEqual(valor,50)

    def test_tarifa_hora_pico_valle_pico_por_15_minutos(self): #Esquina
        inicio = time(6,0)
        fin = time(18,0)
        tarifa = TarifaHoraPico(tarifa_carros=60,tarifa2_carros=100,inicioEspecial=inicio,finEspecial=fin)
    ...
    def test_tarifa_hora_pico_valle_una_hora_mitad_y_mitad(self): #Esquina
        inicio = time(6,0)
        fin = time(18,0)
        tarifa = TarifaHoraPico(tarifa_carros=60,tarifa2_carros=100,inicioEspecial=inicio,finEspecial=fin)
    ...
    def test_tarifa_hora_pico_valle_una_hora_15_minutos_y_3_cuartos_de_hora(self): #Esquina
        inicio = time(6,0)
        fin = time(18,0)
        tarifa = TarifaHoraPico(tarifa_carros=60,tarifa2_carros=100,inicioEspecial=inicio,finEspecial=fin)
    ...
    def test_tarifa_hora_pico_valle_dos_horas_diferentes_dias(self): #Borde
        inicio = time(0,0)
        fin = time(12,0)
        tarifa = TarifaHoraPico(tarifa_carros=60,tarifa2_carros=100,inicioEspecial=inicio,finEspecial=fin)
