...
class TarifaHoraFraccionTestCase(TestCase):
    ...
    def test_tarifa_hora_y_fraccion_una_hora(self):
        ...
        self.assertEqual(rate.calcularPrecio(initial_time,final_time,'Carro'),2)

    def test_tarifa_hora_y_fraccion_una_dos_horas(self):
        initial_time = datetime(2015,2,18,13,0)
        final_time = datetime(2015,2,18,15,0)
        rate = TarifaHorayFraccion(tarifa_carros = 2)
        self.assertEqual(rate.calcularPrecio(initial_time,final_time,'Carro'),4)
    ...
    def test_tarifa_hora_y_fraccion_una_hora_mas_media_hora(self):
        ...
        rate = TarifaHorayFraccion(tarifa_carros = 20)
        self.assertEqual(rate.calcularPrecio(initial_time,final_time,'Carro'),30)
    ...
    def test_tarifa_hora_y_fraccion_una_hora_fraccion_15_minutos(self):
        ...
        self.assertEqual(rate.calcularPrecio(initial_time,final_time,'Carro'),1.5)
    ...
    def test_tarifa_hora_y_fraccion_un_dia(self): # Normal
        ...
        rate = TarifaHorayFraccion(tarifa_carros = 2)
        self.assertEqual(rate.calcularPrecio(initial_time,final_time,'Carro'),48)
    ...
    def test_tarifa_hora_y_fraccion_un_dia_mas_media_hora_mas_un_minuto(self):
        ...
        rate = TarifaHorayFraccion(tarifa_carros = 2)
        self.assertEqual(rate.calcularPrecio(initial_time,final_time,'Carro'),50)
    ...
    def test_tarifa_hora_y_fraccion_dos_dias(self):
        ...
        rate = TarifaHorayFraccion(tarifa_carros = 2)
        self.assertEqual(rate.calcularPrecio(initial_time,final_time,'Carro'),96)
